...
BuildInfos.set(BuildType.GoldMine, new BuildInfo("GoldMine can generate gold. Should build next to gold.", "20 Gold/Hour", 200, 200, 100))
BuildInfos.set(BuildType.IronMine, new BuildInfo("IronMine can generate iron. Should build next to iron.", "20 Iron/Hour", 200, 200, 100))
