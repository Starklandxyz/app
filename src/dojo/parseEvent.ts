...
// import { setComponent, Components, ComponentValue, Type as RecsType, } from "@latticexyz/recs";
import { Entity, setComponent, Components, ComponentValue, Type as RecsType } from "../../node_modules/@latticexyz/recs/src/index"
...
export function setComponentFromEvent(components: Components, eventData: string[]) {
    ...
    const componentValues = Object.keys(component.schema).reduce((acc: ComponentValue, key, index) => {
        ...
        // console.log("componentValues", key, index, value);
